  ...
  "units_of_measurement" : [],
    ...
    "patterns" : {
        ...
        "time scale options" : {
            ...
            "pre_time_scale_replace_text" : {"daily" : "per day", "monthly" : "per month", "yearly" : "per year"},
...
nlq = 'What was the average production of oil per field and state in the year in 2015? '    
